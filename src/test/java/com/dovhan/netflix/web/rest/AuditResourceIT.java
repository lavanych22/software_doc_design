...
import com.dovhan.netflix.config.audit.AuditEventConverter;
import com.dovhan.netflix.domain.PersistentAuditEvent;
import com.dovhan.netflix.repository.PersistenceAuditEventRepository;
import com.dovhan.netflix.security.AuthoritiesConstants;

import com.dovhan.netflix.service.AuditEventService;
