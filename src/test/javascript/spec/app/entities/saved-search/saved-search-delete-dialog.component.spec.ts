...
import { SavedSearchDeleteDialogComponent } from 'app/entities/saved-search/saved-search-delete-dialog.component';
  ...
  describe('SavedSearch Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [SavedSearchDeleteDialogComponent]
      })
